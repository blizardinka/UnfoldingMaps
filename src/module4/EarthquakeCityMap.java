...
//		size(1100, 700, OPENGL);
		if (offline) {
		    map = new UnfoldingMap(this, 200, 50, 850, 700, new MBTilesMapProvider(mbTilesString));
//		    earthquakesURL = "2.5_week.atom";  // The same feed, but saved August 7, 2015
		}
		else {
			map = new UnfoldingMap(this, 200, 50, 850, 600, new Microsoft.RoadProvider ());
		...
		//   Loop over all of the countries, e.g. using 
		    for (Marker cm : countryMarkers) {
			    ...
			    for (Marker qm : quakeMarkers) {
			    	String country  = qm.getStringProperty("country");
...
//		    int quakecounter = 1;
//		    for (Marker qm : quakeMarkers) {
//		    	country  = qm.getStringProperty("country");
//		    	if(country != null) {
...
//		    	}
//		    }
//		    System.out.println("Country: " + country + ":" + quakecounter);
	...
	private boolean isInCountry(PointFeature earthquake, Marker country) {
		...
		Location checkLoc = earthquake.getLocation(); //bekommen hier Location

		// some countries represented it as MultiMarker 
		/*
		 * !!!Was ist das die MultiMarker?
		 */
		// looping over SimplePolygonMarkers which make them up to use isInsideByLoc
		/*
		 *  !!!Was ist die SimplePolygonMarkers?
		 *  !!!Was ist die isInsideByLoc?
		 *  !!!Was ist die AbstractShapeMarker?
		 */
